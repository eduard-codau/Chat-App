...
public class User implements Serializable {
    ...
    public User(Integer userId, String username, String password, String email, Date lastLoginDate, Date lastLoginDateDisplay, String role, String[] authorities, boolean isActive, boolean isNotLocked) {
        this.userId = userId;
